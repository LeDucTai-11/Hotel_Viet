				...
				<c:forEach var="item" items="${listRoles}">
					<tr class="text-center">
						...
						<td class="d-inline-flex">
							<a class="btn btn-secondary" href="<c:url value = '/admin/role?action=edit&id=${item.id}'/>"><b>Cập nhật</b></a>
							<a class="btn btn-danger" href="<c:url value = '/admin/role?action=delete&id=${item.id}'/>" style="margin-left: 16px;"><b>Xóa</b></a>
						</td>
						</c:if>
