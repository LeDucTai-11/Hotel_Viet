...
<body>
	...
	<div class="container-fluid" style="margin-top: 16px;">
		<form action="<c:url value='/admin/city'/>" method="post" style="max-width: 700px;margin: 0 auto">
			...
			<div class="border border-secondary rounded p-3">
				...
				<div class="text-center">
					...
					<a href="<c:url value='/admin/city'/>" class="btn btn-secondary" id="buttonCancel">Cancel</a>
				</div>
